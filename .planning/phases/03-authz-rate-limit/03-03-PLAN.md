...
must_haves:
  ...
  artifacts:
    - path: "src/mcp_sentinel/ratelimit/limiter.py"
      provides: "Redis-backed limiter"
    - path: "src/mcp_sentinel/middleware/rate_limit.py"
      provides: "Middleware enforcing limits"
  key_links:
    - from: "src/mcp_sentinel/middleware/rate_limit.py"
      to: "src/mcp_sentinel/storage/redis.py"
...
<task type="auto">
  ...
  <files>src/mcp_sentinel/ratelimit/limiter.py
src/mcp_sentinel/ratelimit/__init__.py</files>
  <action>
...
<task type="auto">
  ...
  <files>src/mcp_sentinel/middleware/rate_limit.py</files>
  <action>
